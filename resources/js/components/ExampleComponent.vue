<template>
    <v-flex class="left-menu py-4 d-flex flex-column justify-space-between align-center">
        ...
        <nav class="nav d-flex flex-column justify-space-between align-center">
            <router-link :to="{name: 'calendar'}" class="nav-link" aria-current="page">
            ...
            <router-link :to="{name: 'meetings'}" class="nav-link" aria-current="page">
            ...
            <router-link :to="{name: 'structure'}" class="nav-link">
        ...
        <div>
            ...
            <form id="logout-form" action="/logout" method="POST" class="">
                ...
                <button type="submit" class="logout-btn btn btn-outline">
